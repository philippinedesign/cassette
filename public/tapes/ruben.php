...
<head>
  ...
  <title>Ruben Tagalog - Harana Ni Ruben Tagalog | Philippine Cassette Archive </title>
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta charset="UTF-8" />

  <meta name="description" content="Ruben Tagalog - Harana Ni Ruben Tagalog (1970) released by Villar | The Philippine Cassette Archive is an initiative by Developh to archive & celebrating Pinoy cassette culture.">


  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://philippine.design/tapes/tapes/ruben">
  <meta property="og:title" content="Ruben Tagalog - Harana Ni Ruben Tagalog (1970) | Philippine Cassette Archive">
  <meta property="og:description" content="Ruben Tagalog - Harana Ni Ruben Tagalog (1970) released by Villar | The Philippine Cassette Archive is an initiative by Developh to archive & celebrating Pinoy cassette culture.">
  <meta property="og:image" content="https://philippine.design/tapes/preview.png">


  <!-- Twitter -->
  <meta property="twitter:card" content="summary_large_image">
  <meta property="twitter:url" content="https://philippine.design/tapes/tapes/ruben">
  <meta property="twitter:title" content="Ruben Tagalog - Harana Ni Ruben Tagalog (1970) | Philippine Cassette Archive">
...
<body>
    ...
    <div id="title-about">
      <a href="../">
        <h1 title="Go back to archive">
          <span>Ruben Tagalog - Harana Ni Ruben Tagalog</span>
        </h1>
      </a>
    </div>
  ...
  <main>
    ...
    <section id="cover">
      <img data-zoom-image alt="Ruben Tagalog - Harana Ni Ruben Tagalog" title="Ruben Tagalog - Harana Ni Ruben Tagalog" src="./tapes/ruben-cover.jpg">
    </section>
    ...
    <section id="content">
      ...
      <div class="_links">
        <a class="__discogs" href="https://www.discogs.com/release/12747021-Ruben-Tagalog-Harana-Ni-Ruben-Tagalog" title="Find information on Discogs">Discogs</a>
        <a class="__streaming" href="" title="Stream online on Spotify/Youtube">Stream</a>
      </div>


      <div class="images">
        <img data-zoom-image src='./tapes/ruben-cover.jpg'> <img data-zoom-image  alt='Ruben Tagalog - Harana Ni Ruben Tagalog Jcard' src='./tapes/ruben-jcard.jpg'><img data-zoom-image alt='Ruben Tagalog - Harana Ni Ruben Tagalog Tape' src='./tapes/ruben-tape.jpg'>
      </div>
