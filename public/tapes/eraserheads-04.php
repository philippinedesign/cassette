...
<head>
  ...
  <title>Eraserheads - Sticker Happy | Philippine Cassette Archive </title>
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta charset="UTF-8" />

  <meta name="description" content="Eraserheads - Sticker Happy (1997) released by BMG Records | The Philippine Cassette Archive is an initiative by Developh to archive & celebrating Pinoy cassette culture.">


  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://philippine.design/tapes/tapes/eraserheads-04">
  <meta property="og:title" content="Eraserheads - Sticker Happy (1997) | Philippine Cassette Archive">
  <meta property="og:description" content="Eraserheads - Sticker Happy (1997) released by BMG Records | The Philippine Cassette Archive is an initiative by Developh to archive & celebrating Pinoy cassette culture.">
  <meta property="og:image" content="https://philippine.design/tapes/preview.png">


  <!-- Twitter -->
  <meta property="twitter:card" content="summary_large_image">
  <meta property="twitter:url" content="https://philippine.design/tapes/tapes/eraserheads-04">
  <meta property="twitter:title" content="Eraserheads - Sticker Happy (1997) | Philippine Cassette Archive">
...
<body>
    ...
    <div id="title-about">
      <a href="../">
        <h1 title="Go back to archive">
          <span>Eraserheads - Sticker Happy</span>
        </h1>
      </a>
    </div>
  ...
  <main>
    ...
    <section id="cover">
      <img data-zoom-image alt="Eraserheads - Sticker Happy" title="Eraserheads - Sticker Happy" src="./tapes/eraserheads-04-cover.jpg">
    </section>

    <section id="content">
      <div class="_metadata">
        <div class="__year" title="The year the tape was released, presumably">(1997)</div>
        <div class="__label" title="Company or creator who distributed the tape">BMG Records</div>
      </div>

      <div class="_links">
        <a class="__discogs" href="https://www.discogs.com/release/5586584-Eraserheads-Sticker-Happy" title="Find information on Discogs">Discogs</a>
        <a class="__streaming" href="https://open.spotify.com/track/6qKgBptHy91O5wbEs5x9on?si=fc9eff91f1b3499b" title="Stream online on Spotify/Youtube">Stream</a>
      </div>


      <div class="images">
        <img data-zoom-image src='./tapes/eraserheads-04-cover.jpg'> <img data-zoom-image alt='Eraserheads - Sticker Happy Tape' src='./tapes/eraserheads-04-tape.jpg'><img data-zoom-image src='./tapes/eraserheads-04-1.jpg'><img data-zoom-image src='./tapes/eraserheads-04-2.jpg'>
      </div>
