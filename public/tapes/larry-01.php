...
<head>
  ...
  <title>Larry Miranda - Salamisim | Philippine Cassette Archive </title>
...
<body>
    ...
    <div id="title-about">
      <a href="../">
        <h1 title="Go back to archive">
          <span>Larry Miranda - Salamisim</span>
        </h1>
      </a>
    </div>
  ...
  <main>
    ...
    <section id="cover">
      <img data-zoom-image alt="Larry Miranda - Salamisim" title="Larry Miranda - Salamisim" src="./tapes/larry-01-cover.jpg">
    </section>

    <section id="content">
      <div class="_metadata">
        <div class="__year" title="The year the tape was released, presumably">(1972)</div>
        <div class="__label" title="Company or creator who distributed the tape">Plaka Pilipino</div>
      </div>

      <div class="_links">
        <a class="__discogs" href="https://www.discogs.com/release/19602229-Larry-Miranda-Salamisim" title="Find information on Discogs">Discogs</a>
        <a class="__streaming" href="" title="Stream online on Spotify/Youtube">Stream</a>
      </div>


      <div class="images">
        <img data-zoom-image src='./tapes/larry-01-cover.jpg'> <img data-zoom-image  alt='Larry Miranda - Salamisim Jcard' src='./tapes/larry-01-jcard.jpg'>
      </div>
