...
<head>
  ...
  <title>Lea Salonga - Lea Salonga | Philippine Cassette Archive </title>
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta charset="UTF-8" />

  <meta name="description" content="Lea Salonga - Lea Salonga (1993) released by Atlantic Records | The Philippine Cassette Archive is an initiative by Developh to archive & celebrating Pinoy cassette culture.">


  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://philippine.design/tapes/tapes/ls-01">
  <meta property="og:title" content="Lea Salonga - Lea Salonga (1993) | Philippine Cassette Archive">
  <meta property="og:description" content="Lea Salonga - Lea Salonga (1993) released by Atlantic Records | The Philippine Cassette Archive is an initiative by Developh to archive & celebrating Pinoy cassette culture.">
  <meta property="og:image" content="https://philippine.design/tapes/preview.png">


  <!-- Twitter -->
  <meta property="twitter:card" content="summary_large_image">
  <meta property="twitter:url" content="https://philippine.design/tapes/tapes/ls-01">
  <meta property="twitter:title" content="Lea Salonga - Lea Salonga (1993) | Philippine Cassette Archive">
...
<body>
    ...
    <div id="title-about">
      <a href="../">
        <h1 title="Go back to archive">
          <span>Lea Salonga - Lea Salonga</span>
        </h1>
      </a>
    </div>
  ...
  <main>
    ...
    <section id="cover">
      <img data-zoom-image alt="Lea Salonga - Lea Salonga" title="Lea Salonga - Lea Salonga" src="./tapes/ls-01-cover.jpg">
    </section>

    <section id="content">
      <div class="_metadata">
        <div class="__year" title="The year the tape was released, presumably">(1993)</div>
        <div class="__label" title="Company or creator who distributed the tape">Atlantic Records</div>
      </div>

      <div class="_links">
        <a class="__discogs" href="https://www.discogs.com/release/14315924-Lea-Salonga-LeaSalonga" title="Find information on Discogs">Discogs</a>
        <a class="__streaming" href="https://open.spotify.com/album/1McJxNj5QoF8LPBiEPvnwG?si=88HWyizoRkG8lZzrotba6Q" title="Stream online on Spotify/Youtube">Stream</a>
      </div>


      <div class="images">
        <img data-zoom-image src='./tapes/ls-01-cover.jpg'> <img data-zoom-image  alt='Lea Salonga - Lea Salonga Jcard' src='./tapes/ls-01-jcard.jpg'>
      </div>
