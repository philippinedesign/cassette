...
<head>
  ...
  <title>Juan De La Cruz Band - Live & In Concert | Philippine Cassette Archive </title>
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta charset="UTF-8" />

  <meta name="description" content="Juan De La Cruz Band - Live & In Concert (1978) released by Sunshine | The Philippine Cassette Archive is an initiative by Developh to archive & celebrating Pinoy cassette culture.">


  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://philippine.design/tapes/tapes/juan-01">
  <meta property="og:title" content="Juan De La Cruz Band - Live & In Concert (1978) | Philippine Cassette Archive">
  <meta property="og:description" content="Juan De La Cruz Band - Live & In Concert (1978) released by Sunshine | The Philippine Cassette Archive is an initiative by Developh to archive & celebrating Pinoy cassette culture.">
  <meta property="og:image" content="https://philippine.design/tapes/preview.png">


  <!-- Twitter -->
  <meta property="twitter:card" content="summary_large_image">
  <meta property="twitter:url" content="https://philippine.design/tapes/tapes/juan-01">
  <meta property="twitter:title" content="Juan De La Cruz Band - Live & In Concert (1978) | Philippine Cassette Archive">
...
<body>
    ...
    <div id="title-about">
      <a href="../">
        <h1 title="Go back to archive">
          <span>Juan De La Cruz Band - Live & In Concert</span>
        </h1>
      </a>
    </div>
  ...
  <main>
    ...
    <section id="cover">
      <img data-zoom-image alt="Juan De La Cruz Band - Live & In Concert" title="Juan De La Cruz Band - Live & In Concert" src="./tapes/juan-01-cover.jpg">
    </section>
    ...
    <section id="content">
      ...
      <div class="_links">
        <a class="__discogs" href="https://www.discogs.com/release/4597598-Juan-De-La-Cruz-Band-Live-In-Concert" title="Find information on Discogs">Discogs</a>
        <a class="__streaming" href="" title="Stream online on Spotify/Youtube">Stream</a>
      </div>


      <div class="images">
        <img data-zoom-image src='./tapes/juan-01-cover.jpg'> <img data-zoom-image  alt='Juan De La Cruz Band - Live & In Concert Jcard' src='./tapes/juan-01-jcard.jpg'><img data-zoom-image alt='Juan De La Cruz Band - Live & In Concert Tape' src='./tapes/juan-01-tape.jpg'><img data-zoom-image src='./tapes/juan-01-1.jpg'><img data-zoom-image src='./tapes/juan-01-2.jpg'>
      </div>
