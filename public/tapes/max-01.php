...
<head>
  ...
  <title>Max Surban - Mad Max Kuno | Philippine Cassette Archive </title>
  <meta http-equiv="X-UA-Compatible" content="IE=edge" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <meta charset="UTF-8" />

  <meta name="description" content="Max Surban - Mad Max Kuno (1984) released by Sunshine | The Philippine Cassette Archive is an initiative by Developh to archive & celebrating Pinoy cassette culture.">


  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://philippine.design/tapes/tapes/max-01">
  <meta property="og:title" content="Max Surban - Mad Max Kuno (1984) | Philippine Cassette Archive">
  <meta property="og:description" content="Max Surban - Mad Max Kuno (1984) released by Sunshine | The Philippine Cassette Archive is an initiative by Developh to archive & celebrating Pinoy cassette culture.">
  <meta property="og:image" content="https://philippine.design/tapes/preview.png">


  <!-- Twitter -->
  <meta property="twitter:card" content="summary_large_image">
  <meta property="twitter:url" content="https://philippine.design/tapes/tapes/max-01">
  <meta property="twitter:title" content="Max Surban - Mad Max Kuno (1984) | Philippine Cassette Archive">
...
<body>
    ...
    <div id="title-about">
      <a href="../">
        <h1 title="Go back to archive">
          <span>Max Surban - Mad Max Kuno</span>
        </h1>
      </a>
    </div>
  ...
  <main>
    ...
    <section id="cover">
      <img data-zoom-image alt="Max Surban - Mad Max Kuno" title="Max Surban - Mad Max Kuno" src="./tapes/max-01-cover.jpg">
    </section>
    ...
    <section id="content">
      ...
      <div class="_links">
        <a class="__discogs" href="https://www.discogs.com/release/21460624-Max-Surban-Mad-Max-Kuno" title="Find information on Discogs">Discogs</a>
        <a class="__streaming" href="" title="Stream online on Spotify/Youtube">Stream</a>
      </div>


      <div class="images">
        <img data-zoom-image src='./tapes/max-01-cover.jpg'> <img data-zoom-image  alt='Max Surban - Mad Max Kuno Jcard' src='./tapes/max-01-jcard.jpg'><img data-zoom-image src='./tapes/max-01-1.jpg'>
      </div>
